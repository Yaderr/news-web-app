...
const IsNotSaved = ({ color }) => {
    return (
        <svg className={`w-full h-full stroke-${color}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SaveArticleButton = ({ className, color='blue-vogue', article }) => {
